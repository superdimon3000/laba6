...
class Bb ( models.Model):
    ...
    content = models.TextField(null=True, blank=True, verbose_name='Характеристика')
    ...
    rubric = models.ForeignKey('Rubric', null=True, on_delete=models.PROTECT, verbose_name='Розділ')
